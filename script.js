...
const translations = {
  en: {
    ...
    "music.title": "No camera needed",
    "music.focus": "Play music. G1 moves to the beat",
    "music.description": "No wearables. No camera. When the music starts, G1 moves naturally with the rhythm.",
  ...
  zh: {
    ...
    "music.type": "音乐驱动 · 零设备",
    "music.title": "连摄像头都不需要",
    "music.focus": "听见音乐，G1 自然舞动",
    "music.description": "无需穿戴，也无需站在镜头前。一段音乐响起，G1 便随节奏自然起舞",
    "music.signal": "音乐输入",
